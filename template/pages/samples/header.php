        ...
        <ul class="nav">
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                ...
                <div class="dropdown-divider"></div>
                  ...
                  <div class="preview-item-content">
                    ...
                    <a href="logout.php" class="btn btn-success mx-5 my-3">Logout</a></p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addservice.php">Add New Service</a></li>
                <li class="nav-item"> <a class="nav-link" href="services.php">View All Services</a></li>
          ...
          <a class="nav-link" data-toggle="collapse" href="#ui-basic2" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addemployees.php">Add New Employee</a></li>
                <li class="nav-item"> <a class="nav-link" href="employee.php">View All Employees</a></li>
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <!-- <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">+ Add new Deal</a> -->
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">SALOON MANEGMENT</p>
